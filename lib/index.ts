...
export default class FedExAPI {
  ...
  constructor(
    ...
    // this.endpoint = this.isProduction ? 'https://ws.fedex.com:443/web-services' : 'https://wsbeta.fedex.com';
    this.endpoint = 'https://ws.fedex.com:443';
    // this.endpoint = 'https://ene2102bth1gd.x.pipedream.net';
  }
  ...
  public upload(params: any, cb: any) {
    ...
    this.request(params, 'uploadImages', 'UploadDocumentService_v11.wsdl', resource, (err, res) => {
      return cb(err, res);
    });
  ...
  public track(params: any, cb: any) {
    ...
    this.request(params, 'track', 'TrackService_v19.wsdl', resource, (err, res) => {
      return cb(err, res);
    });
